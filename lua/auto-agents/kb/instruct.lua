...
local function render_block(spec, kb_root)
  ...
  local lines = {
    ...
    "  bootstrap doc at `$AUTO_AGENTS_MAILBOX_DIR/../bootstrap-mailbox.md`**",
    "  (the tool-root-level doc, one level up from your own mailbox dir).",
    "  It is the canonical protocol contract: wake semantics, message",
    "  shape, atomic-write contract, responding via `responses/`, etc.",
    "  Re-read it whenever its `revision:` frontmatter differs from the",
    "  value you last acknowledged.",
